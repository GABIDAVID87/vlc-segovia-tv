...
class MainTvFragment : BrowseSupportFragment(), OnItemViewSelectedListener, OnItemViewClickedListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        badgeDrawable = ContextCompat.getDrawable(requireContext(), R.mipmap.segovia_stv_icon_round)
...
//        }
    ...
    override fun onResume() {
        super.onResume()
        badgeDrawable = ContextCompat.getDrawable(requireContext(), if (Settings.incognitoMode) R.drawable.ic_incognito else R.mipmap.segovia_stv_icon_round)
    }
