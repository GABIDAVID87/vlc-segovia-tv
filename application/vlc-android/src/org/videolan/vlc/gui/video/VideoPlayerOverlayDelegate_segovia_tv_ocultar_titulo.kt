...
class VideoPlayerOverlayDelegate (private val player: VideoPlayerActivity) {
    ...
    fun showControls(show: Boolean) {
        ...
        if (::hudBinding.isInitialized) {
            ...
            // SEGOVIA TV: branding only appears while the playback controls are visible.
            hudBinding.segoviaTvBranding.visibility = if (show) View.VISIBLE else View.GONE
            if (seekButtons) {
        ...
        if (::hudRightBinding.isInitialized) {
            // SEGOVIA TV: movie/series title is part of the same HUD visibility.
            hudRightBinding.playerOverlayTitle.visibility = if (show) View.VISIBLE else View.GONE
            hudRightBinding.playerOverlayTitleWarning.visibility = if (show) View.VISIBLE else View.GONE
